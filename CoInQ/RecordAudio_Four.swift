...
class RecordAudio_Four: UIViewController , AVAudioPlayerDelegate, AVAudioRecorderDelegate {
...
//            VideoNameArray[Index].useRecordfour = false
    ...
    func getaudio(){
        let parameters: Parameters=["videoid": Index,"num": 4]
                ...
                if let audioinfo = JSON["audiopath"] as? String {
                    ...
                    if !(audiopath.isEmpty) {
                        ...
                        if FileManager.default.fileExists(atPath: (url?.path)!) {
                            ...
                            UserDefaults.standard.set(self.AudioURL!, forKey: "recordfour")
    ...
    @IBAction func record(_ sender: AnyObject) {
        ...
        if soundRecorder.isRecording{
            ...
            if progressViewTimer != nil {
                ...
                StoreRecord(directoryURL()!,"userecordfour",clip: 4)
            }
            //showTimeLabel()
            ...
            case .success(let upload, _, _):
                ...
                upload.responseJSON { response in
                    ...
                    if success == 1 {
                        ...
                        UserDefaults.standard.set(audiourl, forKey: "recordfour")
                        self.showSwitch()
                    }else{
                        print("Upload Failed")
                    }
