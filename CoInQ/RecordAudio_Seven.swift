...
class RecordAudio_Seven: UIViewController , AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    @IBAction func UseRecordSwitch(_ sender: UISwitch) {
        ...
        if sender.isOn {
            ...
            UserDefaults.standard.set(true, forKey: "userecordseven")
        }else{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
            setupRecorder()
            getaudio()
            videourl = RecordAudio_One().getvideo("videoseven_path")
            ...
            UserDefaults.standard.set(false, forKey: "userecordseven")
    }
                ...
                if let audioinfo = JSON["audiopath"] as? String {
                    ...
                    if !(audiopath.isEmpty) {
                        ...
                        if FileManager.default.fileExists(atPath: (url?.path)!) {
                            ...
                            UserDefaults.standard.set(self.AudioURL!, forKey: "recordseven")
                            self.UseRecordSwitch.isOn = false
                            
                        } else {
                            //self.donloadVideo(url: url!)
                            print("FILE 7 NOT FOUND")
    ...
    @IBAction func record(_ sender: AnyObject) {
        ...
        if soundRecorder.isRecording{
            ...
            if progressViewTimer != nil {
                ...
                StoreRecord(directoryURL()!,"userecordseven",clip: 7)
            }
            //showTimeLabel()
    ...
    @IBAction func playvideo(_ sender: AnyObject) {
        lognote("pr7", google_userid, "\(Index)")
    ...
    func updateTimeLabel(_ timer: Timer) {
        if timeLabel.text != "00:00.00"{
            ...
            timeTimer?.invalidate()
            StoreRecord(directoryURL()!,"userecordseven",clip: 7)
            UserDefaults.standard.set(directoryURL()!, forKey: "recordseven")
        }
    }
            ...
            case .success(let upload, _, _):
                ...
                upload.responseJSON { response in
                    ...
                    if success == 1 {
                        ...
                        UserDefaults.standard.set(audiourl, forKey: "recordseven")
                        self.showSwitch()
                    }else{
                        print("Upload Failed")
                    }
