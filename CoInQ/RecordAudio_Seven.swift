...
class RecordAudio_Seven: UIViewController , AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            let videoURL = URL(string: VideoNameArray[Index].videoseven!)
            ...
            if (VideoNameArray[Index].audioseven) != nil {
    ...
    @IBAction func Explain(_ sender: Any) {
        let myAlert: UIAlertController = UIAlertController(title:"小解釋",message:"我可以說明我觀察到的\n科學家使用的科學方法與研究結果。",preferredStyle: .alert)
    ...
    func directoryURL() -> URL? {
        ...
        let soundURL = documentDirectory.appendingPathComponent("sound7.m4a")
        return soundURL
    }
    ...
    func StoreRecordPathInUserdefault() {
        VideoNameArray[Index].audioseven = directoryURL()?.absoluteString
        AudioURL = directoryURL()
        VideoNameArray[Index].useRecordseven = true
