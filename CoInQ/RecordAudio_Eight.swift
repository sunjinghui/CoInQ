...
class RecordAudio_Eight: UIViewController , AVAudioPlayerDelegate, AVAudioRecorderDelegate {
    ...
    @IBAction func UseRecordSwitch(_ sender: UISwitch) {
        ...
        if sender.isOn {
            ...
            UserDefaults.standard.set(true, forKey: "userecordeight")
        }else{
    ...
    override func viewDidLoad() {
        ...
        setupRecorder()
        getaudio()
        videourl = RecordAudio_One().getvideo("videoeight_path")
            ...
            UserDefaults.standard.set(false, forKey: "userecordeight")
    }
    
    func getaudio(){
        let parameters: Parameters=["videoid": Index,"num": 8]
                ...
                if let audioinfo = JSON["audiopath"] as? String {
                    ...
                    if !(audiopath.isEmpty) {
                        ...
                        if FileManager.default.fileExists(atPath: (url?.path)!) {
                            ...
                            UserDefaults.standard.set(self.AudioURL!, forKey: "recordeight")
                            self.UseRecordSwitch.isOn = false
                            
                        } else {
                            //self.donloadVideo(url: url!)
                            print("FILE 8 NOT FOUND")
    ...
    @IBAction func record(_ sender: AnyObject) {
        ...
        if soundRecorder.isRecording{
            ...
            if progressViewTimer != nil {
                ...
                StoreRecord(directoryURL()!,"userecordeight",clip: 8)
            }
            //showTimeLabel()
    ...
    @IBAction func playvideo(_ sender: AnyObject) {
        lognote("pr8", google_userid, "\(Index)")
            ...
            case .success(let upload, _, _):
                ...
                upload.responseJSON { response in
                    ...
                    if success == 1 {
                        ...
                        UserDefaults.standard.set(audiourl, forKey: "recordeight")
                        self.showSwitch()
                    }else{
                        print("Upload Failed")
                    }
